...
\subsection{Mining several blocks}
...
\subsection{Analysis of network's hash rate change}
...
\subsubsection{Hash rate suddenly changing}
...
\subsubsection{Hash rate smoothly changing}
...
\subsubsection{Piecewise linear model of hash rate change}
...
\subsection{Attack in the Bitcoin network}
% Ataque submarino
...
\subsection{Confirmation time and network capacity}
